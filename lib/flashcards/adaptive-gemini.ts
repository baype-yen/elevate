...
const SYSTEM_INSTRUCTION = `Tu es un professeur d'anglais spécialisé en remédiations CECRL.
Tu dois créer des flashcards QCM (choix unique) adaptées au niveau de l'élève.

Contraintes strictes:
- Écris la consigne en français.
- Les exemples/phrases en anglais sont autorisés quand nécessaire.
- Chaque flashcard doit être un QCM à choix unique.
- Fournis 3 ou 4 options plausibles.
- "correct_option" doit être exactement une des options.
- La difficulté doit correspondre strictement au niveau CECRL demandé.
- Reste limité aux thèmes: vocabulary, grammar, tense.
- Donne une explication courte et utile en français.
...
function buildPrompt(input: GenerateAdaptiveFlashcardsInput) {
  const hints = [
    `Catégorie cible: ${input.category}`,
    `Niveau CECRL cible: ${input.level.toUpperCase()}`,
    `Nombre de flashcards à générer: ${Math.max(1, Math.min(6, input.count))}`,
  ]

  if (input.weakTopic) {
    hints.push(`Point faible détecté: ${input.weakTopic}`)
  }

  if (input.wrongOption) {
    hints.push(`Mauvaise option choisie par l'élève: ${input.wrongOption}`)
  }

  return [
    ...hints,
    "",
    "Génère des QCM à choix unique utiles pour faire progresser l'élève.",
    "Chaque question doit être répondable rapidement.",
...
const VOCAB_BANK: Record<CefrLevel, Array<{ question: string; options: string[]; answer: string; explanation: string }>> = {
  a1: [
    ...
    {
      question: "Quel mot anglais correspond à 'pomme' ?",
  ...
  b1: [
    {
      question: "Quel mot signifie 'améliorer' en anglais ?",
      options: ["improve", "arrive", "borrow", "forget"],
      answer: "improve",
      explanation: "'Improve' signifie améliorer.",
    },
    {
  ...
  b2: [
    ...
    {
      question: "Quel mot correspond à 'réussite' ?",
      options: ["achievement", "equipment", "warning", "opinion"],
      answer: "achievement",
      explanation: "'Achievement' désigne une réussite obtenue.",
    },
  ],
  c1: [
    {
      ...
      answer: "sustainable",
      explanation: "'Sustainable' correspond à durable dans un contexte de long terme.",
    },
    {
  ...
  c2: [
    {
      question: "Quel verbe correspond le mieux à 'transmettre une idée' ?",
      options: ["convey", "ignore", "delay", "regret"],
      answer: "convey",
      explanation: "'Convey' signifie transmettre une idée ou un message.",
    },
    {
      question: "Dans un debat, que signifie 'nuance' en anglais ?",
      options: ["nuance", "surface", "shortcut", "defect"],
      answer: "nuance",
      explanation: "Le mot est identique en anglais dans ce contexte académique.",
    },
  ],
}
...
const GRAMMAR_BANK: Record<CefrLevel, Array<{ question: string; options: string[]; answer: string; explanation: string }>> = {
  a1: [
    {
      ...
      explanation: "Avec he/she/it au présent simple, on ajoute -s au verbe.",
    },
    {
  ...
  b1: [
    {
      ...
      explanation: "Avec 'for + durée', on emploie souvent le present perfect.",
    },
    {
  ...
  b2: [
    {
      question: "Choisis la phrase correcte au conditionnel irréel.",
      ...
      explanation: "Dans un conseil hypothétique, on utilise souvent 'If I were...'.",
    },
    {
      ...
      explanation: "Après 'Hardly', inversion auxiliaire + sujet au style soutenu.",
    },
  ],
  c1: [
    {
    ...
    },
    {
      ...
      explanation: "Le subjonctif anglais peut apparaître après certaines structures formelles.",
    },
  ],
  c2: [
    {
      question: "Choisis la phrase la plus précise et correcte.",
      ...
      explanation: "Forme inversive avancée pour exprimer une condition hypothétique.",
    },
    {
      question: "Quelle phrase respecte le registre académique ?",
  ...
  a1: [
    {
      ...
      answer: "goes",
      explanation: "Habitude au présent simple avec he/she/it: verbe + s.",
    },
    {
  ...
  a2: [
    {
      ...
      answer: "got",
      explanation: "'Yesterday' appelle en général le preterit.",
    },
    {
      question: "Choose the best tense: 'I ___ my keys. I can't find them.'",
      options: ["have lost", "lost", "am losing", "lose"],
      answer: "have lost",
      explanation: "Résultat présent d'une action passée: present perfect.",
    },
  ],
  b1: [
    {
    ...
    },
    {
      ...
      answer: "were having",
      explanation: "Action en cours dans le passé: past continuous.",
    },
  ],
  b2: [
    {
      ...
      answer: "had started",
      explanation: "Action antérieure à une autre action passée: past perfect.",
    },
    {
      ...
      explanation: "Future continuous pour une action en cours à un moment futur.",
    },
  ],
  c1: [
    {
      ...
      explanation: "Future perfect: action accomplie avant un repère futur.",
    },
    {
      question: "Complete: 'I wish I ___ that earlier.'",
      options: ["had known", "know", "have known", "was knowing"],
      answer: "had known",
      explanation: "Avec 'I wish' sur un regret passé, on utilise le past perfect.",
    },
  ],
  c2: [
    {
      ...
      explanation: "Structure avancée avec inversion et concordance précise des temps.",
    },
    {
      ...
      explanation: "Conditionnel passé formel avec inversion correcte et résultat hypothétique.",
    },
  ],
}
